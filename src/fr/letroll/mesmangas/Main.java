...
public class Main extends RoboTabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (tuto) {
			...
			t1.setText("(cette application nécessite un accès à internet, l’utilisation du wifi est conseillé.) Bonjour et bienvenue dans mesmangas," + "faites défiler cette page vers le haut pour apprendre à utiliser l’application.pour commencer, appuyer sur ");
