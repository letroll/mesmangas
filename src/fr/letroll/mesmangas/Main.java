...
//    @InjectView(R.id.flipper) ViewFlipper mFlipper;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (tuto) {
            ...
            b1.setText("quitter");b1.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                    monTuto.cancel();
                }
            });
            TextView t1 = (TextView) monTuto.findViewById(R.id.textView2);
            t1.setText("(cette application nécessite un accès à internet, l’utilisation du wifi est conseillé.) Bonjour et bienvenue dans mesmangas,"
                    + "faites défiler cette page vers le haut pour apprendre à utiliser l’application.pour commencer, appuyer sur ");
            TextView t2 = (TextView) monTuto.findViewById(R.id.textView1);
            t2.setText("selectionner la langue à votre convenance, et enfin patienté." + "L’application Mesmangas va chercher tous les titres disponibles sur le site internet sélectionné."
                    + "Votre manga trouvé, appuyer sur son nom pour l’ajouter à votre liste de lecture." + "il ne vous reste plus qu’à regarder vos manga en appuyant sur");
            monTuto.show();
